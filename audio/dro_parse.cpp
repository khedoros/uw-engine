        ...
        if(reg == sh_delay) cout<<" Delay "<<int(val)+1<<"ms"<<endl;
            ...
            switch(reg_trans[reg]) {
              ...
              case 0x35:
                  ...
                  cout<<"Freq mult: "<<int(val & 0x0f)<<")"<<endl;
                  break;
              ...
              case 0x54:
              case 0x55:
                  cout<<" (Set Op"<<op(reg_trans[reg])<<" Ch. "<<chan(reg_trans[reg])<<" to Level Scaling: "<<int((val & 0xc0)>>(6))<<" Output attenuation: "<<int(val & 0x3f)<<")"<<endl;
                  break;
